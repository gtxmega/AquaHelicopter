...
Shader "Amazing Assets/Curved World/Complex Lit"
{
    Properties
    {
        [CurvedWorldBendSettings] _CurvedWorldBendSettings("0,2,4,5,6,10,21|1|1", Vector) = (0, 0, 0, 0)
...
#pragma shader_feature_local CURVEDWORLD_BEND_TYPE_CLASSICRUNNER_X_POSITIVE CURVEDWORLD_BEND_TYPE_CLASSICRUNNER_Z_POSITIVE CURVEDWORLD_BEND_TYPE_LITTLEPLANET_X CURVEDWORLD_BEND_TYPE_LITTLEPLANET_Z CURVEDWORLD_BEND_TYPE_CYLINDRICALROLLOFF_Z CURVEDWORLD_BEND_TYPE_SPIRALVERTICAL_Z_POSITIVE CURVEDWORLD_BEND_TYPE_LITTLEPLANET_Y
